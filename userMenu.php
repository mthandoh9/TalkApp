  ...
  <nav class="navbar navbar-expand-lg bg-white fixed-top nav-down navbar-transparent" color-on-scroll="500">
    <div class="container">
      <div class="navbar-translate">
        <a class="navbar-brand" href="#" rel="tooltip" title="Talk To ME" data-placement="bottom" target="_blank">
      ...
      <div class="collapse navbar-collapse" data-nav-image="assets/img/blurred-image-1.jpg" data-color="orange">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="btn btn-round btn-primary" href="logout.php" target="_blank">
               Profile
            </a>
          </li>
          <li class="nav-item">
            <a class="btn btn-round btn-danger" href="logout.php" target="_blank">
               Log Out
            </a>
          </li>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 ml-auto mr-auto">
            <div class="card card-register">
              ...
              <form class="register-form" method="post" action="">
                <table><tr><td><a class="btn" href="posts.php">News Feed</a></td><td><a class="btn" href="getFriendlist.php">Messages</a></td></tr>
